...
export function roleChangeStatus(data: any) {
  return requestClient.putWithMsg(Api.roleChangeStatus, data);
}

export function roleRemove(roleIds: IDS) {
  return requestClient.deleteWithMsg(`${Api.root}/${roleIds}`);
}
...
export function roleDataScope(data: any) {
  return requestClient.putWithMsg(Api.roleDataScope, data);
}
...
export function roleAuthCancel(data: any) {
  return requestClient.putWithMsg(Api.roleAuthCancel, data);
}
